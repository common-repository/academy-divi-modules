...
class ACDM_AcademyLoginForm extends ET_Builder_Module {

	public $slug       = 'acdm_login_form';
	...
	public function init() {
		$this->name = esc_html__( 'Academy Login Form', 'academy-divi-modules' );
		...
		$this->settings_modal_toggles = array(
			...
			'advanced' => array(
				'toggles' => array(
					...
					'form_heading'     => esc_html__( 'Form Heading', 'academy-divi-modules' ),
			...
			$this->advanced_fields = array(
				// Typography Controls
				'fonts'          => array(
					'form_heading_font'      => array(
						'css'             => array(
							'main' => '.academy-login-form-wrapper .academy-login-form-heading',
						),
						'hide_text_align' => false,
						'tab_slug'        => 'advanced',
						'toggle_slug'     => 'form_heading',
					),
					'form_label_font'      => array(
						'css'             => array(
							'main' => '.academy-login-form .academy-form-group label',
						),
					...
					'form_placeholder_font'      => array(
						'css'             => array(
							'main' => '.academy-login-form .academy-form-group input::placeholder',
						),
						'hide_text_align' => true,
						'tab_slug'        => 'advanced',
					...
					'form_field_font'      => array(
						'css'             => array(
							'main' => '.academy-login-form .academy-form-group input',
						),
						'hide_text_align' => true,
						'tab_slug'        => 'advanced',
					...
					'form_button_font'      => array(
						'css'             => array(
							'main' => '.academy-login-form .academy-form-group button',
						),
						'hide_text_align' => true,
						'tab_slug'        => 'advanced',
				...
				'borders'        => array(
					...
					'form_container' => array(
						'css'         => array(
							'main'      => array(
								'border_radii'  => '%%order_class%% .academy-login-form-wrapper',
								'border_styles' => '%%order_class%% .academy-login-form-wrapper',
							),
							'important' => true,
						),
						'tab_slug'        => 'advanced',
					...
					'form_heading_border' => array(
						'css'         => array(
							'main'      => array(
								'border_radii'  => '%%order_class%% .academy-login-form-wrapper .academy-login-form-heading',
								'border_styles' => '%%order_class%% .academy-login-form-wrapper .academy-login-form-heading',
							),
							'important' => true,
						),
						'tab_slug'        => 'advanced',
					...
					'form_field_border' => array(
						'css'         => array(
							'main'      => array(
								'border_radii'  => '%%order_class%% .academy-login-form .academy-form-group input',
								'border_styles' => '%%order_class%% .academy-login-form .academy-form-group input',
							),
							'important' => true,
						),
						'tab_slug'        => 'advanced',
					...
					'form_button_border' => array(
						'css'         => array(
							'main'      => array(
								'border_radii'  => '%%order_class%% .academy-login-form .academy-form-group button',
								'border_styles' => '%%order_class%% .academy-login-form .academy-form-group button',
							),
							'important' => true,
						),
						'tab_slug'        => 'advanced',
				...
				'background'     => array(
					'css'                  => array(
						'main'      => '%%order_class%% .academy-login-form-wrapper',
						'important' => true,
					),
					'settings'             => array(
						'tab_slug'    => 'advanced',
	...
	public function get_fields() {
		return array(           
            'form_title'     => array(
				'label'           => esc_html__( 'Form Title', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'heading',
                'default'         => 'My Login Page',
				'computed_affects' => array(
					'__shortcode',
				),
			),
			'username_label'     => array(
				'label'           => esc_html__( 'Username Label', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
			...
			'username_placeholder'     => array(
				'label'           => esc_html__( 'Username Placeholder', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'form_fields',
                'default'         => 'Username or Email Address',
			...
			'password_label'     => array(
				'label'           => esc_html__( 'Password Label', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'form_fields',
                'default'         => 'Password',
			...
			'password_placeholder'     => array(
				'label'           => esc_html__( 'Password Placeholder', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'form_fields',
                'default'         => 'Password',
			...
			'remember_label'     => array(
				'label'           => esc_html__( 'Remember Label', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'form_fields',
                'default'         => 'Remember Me',
			...
			'reset_password_label'     => array(
				'label'           => esc_html__( 'Reset Password Label', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'form_fields',
			...
			'login_button_label'     => array(
				'label'           => esc_html__( 'Login Button Label', 'academy-divi-modules' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'toggle_slug'     => 'button',
                'default'         => 'Log In',
			...
			'form_heading_margin_bottom' => array(
				'label'           => esc_html__( 'Bottom Margin', 'academy-divi-modules' ),
				'type'            => 'range',
				'tab_slug'    => 'advanced',
				'toggle_slug'     => 'form_heading',
			...
			'form_heading_margin_left' => array(
				'label'           => esc_html__( 'Left Margin', 'academy-divi-modules' ),
				'type'            => 'range',
				'tab_slug'    => 'advanced',
				'toggle_slug'     => 'form_heading',
			...
			'form_heading_margin_right' => array(
				'label'           => esc_html__( 'Rigth Margin', 'academy-divi-modules' ),
				'type'            => 'range',
				'tab_slug'    => 'advanced',
				'toggle_slug'     => 'form_heading',
	...
	public static function get_shortcode($settings = array()) {
		...
		$shortcode = '[academy_login_form ' . Helper::attr_shortcide( $attr_array ) . ']';
    ...
    public function render( $attrs, $content = null, $render_slug ) {
		...
		ET_Builder_Element::set_style( $render_slug, array(
			'selector'    => '%%order_class%% .academy-login-form-wrapper',
			'declaration' => sprintf(
				'margin-top: %1$s;',
		...
		ET_Builder_Element::set_style( $render_slug, array(
			'selector'    => '%%order_class%% .academy-login-form-wrapper .academy-login-form-heading',
			'declaration' => sprintf(
				'margin-top: %1$s;',
				esc_html( $this->props['form_heading_margin_top'].'px' )
			),
		));
		...
		ET_Builder_Element::set_style( $render_slug, array(
			...
			'declaration' => sprintf(
				'margin-bottom: %1$s;',
				esc_html( $this->props['form_heading_margin_bottom'].'px' )
			),
		));
		...
		ET_Builder_Element::set_style( $render_slug, array(
			...
			'declaration' => sprintf(
				'margin-left: %1$s;',
				esc_html( $this->props['form_heading_margin_left'].'px' )
			),
		));
		...
		ET_Builder_Element::set_style( $render_slug, array(
			...
			'declaration' => sprintf(
				'margin-right: %1$s;',
				esc_html( $this->props['form_heading_margin_right'].'px' )
			),
		));
		...
		ET_Builder_Element::set_style( $render_slug, array(
			...
			'declaration' => sprintf(
				'padding: %1$s;',
				esc_html( $this->props['form_heading_padding'].'px' )
			),
		));
		...
		ET_Builder_Element::set_style( $render_slug, array(
			'selector'    => '%%order_class%% .academy-login-form .academy-form-group label',
			'declaration' => sprintf(
				'margin-top: %1$s;',
		...
		ET_Builder_Element::set_style( $render_slug, array(
			'selector'    => '%%order_class%% .academy-login-form .academy-form-group input',
			'declaration' => sprintf(
				'margin-top: %1$s;',
		...
		ET_Builder_Element::set_style( $render_slug, array(
			'selector'    => '%%order_class%% .academy-login-form .academy-form-group button:hover',
			'declaration' => sprintf(
				'background-color: %1$s;',
